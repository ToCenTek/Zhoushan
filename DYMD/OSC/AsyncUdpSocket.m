...
- (void)scheduleDequeueSend
{
    //NSLog(@"scheduleDequeueSend22222");
	if((theFlags & kDequeueSendScheduled) == 0)
	{
        //NSLog(@"scheduleDequeueSend");
        
        
		theFlags |= kDequeueSendScheduled;
        [self maybeDequeueSend];
  		//[self performSelector:@selector(maybeDequeueSend) withObject:nil afterDelay:0 inModes:[NSArray arrayWithObject:NSDefaultRunLoopMode]];
	}
}
